  ...
  const projects = [
    {
      name: "idleparts",
      src: idlepartsSrc,
      link: "https://github.com/MadGotten/idleparts",
    },
    {
      name: "social-life",
      src: socialLifeSrc,
      link: "https://github.com/MadGotten/Social-Life",
    },
    {
      name: "eventio",
      src: eventioSrc,
      link: "https://github.com/MadGotten/Eventio",
    },
  ];
    ...
    >
      ...
      <div className="flex md:flex-row flex-col items-stretch  justify-center gap-8 flex-wrap dark:text-white text-black">
        {projects.map((project, index) => (
          <div
            key={index}
            className="flex gap-2 p-4 flex-col border border-light w-[362px] rounded-lg"
          >
            <Image
              src={project.src}
            ...
            ></Image>
            <h4 className="text-xl leading-normal font-medium">
              {t(`${project.name}.title`)}
            </h4>
            <p className="text-base">{t(`${project.name}.body`)}</p>
            <div className="flex items-end flex-1 mt-2">
              <Link href={project.link} target="_blank" className="w-10 h-10">
